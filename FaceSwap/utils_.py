...
# from FaceSwap.R3FR_predictor import r3fa_landmark
import R3FR_predictor as R3FR_predictor
...
def getFaceTextureCoords(img, mean3DShape, blendshapes, idxs2D, idxs3D, detector, model,predictor):
